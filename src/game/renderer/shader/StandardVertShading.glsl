...
void main(){
	...
	Normal_cameraspace = ( V * M * vec4(vertexNormal_modelspace,0)).xyz; // Only correct if ModelMatrix does not scale the model_transform ! Use its inverse transpose if not.
